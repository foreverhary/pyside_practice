...
"}")
        ...
        icon2 = QIcon()
        icon2.addFile(u":/icons/feather/menu.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.label_3.setPixmap(QPixmap(u":/images/22-logo.png"))
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/feather/more-horizontal.svg", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"22-Modern UI", None))
#if QT_CONFIG(tooltip)
